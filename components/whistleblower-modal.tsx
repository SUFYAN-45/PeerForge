...
import { 
  X, Shield, AlertTriangle, Eye, EyeOff, Send, Trash2, 
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="w-full max-w-lg bg-black/90 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden">
              {/* Incognito Header */}
              <div className="bg-white/5 px-6 py-4 border-b border-white/10">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="font-semibold text-white">Secure Report</h2>
